...
class RegressionEfficientNet(nn.Module):
    ...
    （過学習抑制と汎化性能向上を重視）
    """
    def __init__(self, version='b2', out_features=1, freeze_base=True, unfreeze_layers=2, dropout_p =0.8, pretrained=True):#versonでモデルの種類を指定 :pretrained=True:事前学習有り、pretrained=False:事前学習無し
        super().__init__() 
