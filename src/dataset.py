...
class AnnotatedDatasetFolder(torchdata.Dataset):
    ...
    """
    def __init__(self, root, loader, transform=None, annotation_file=None, dataframe=None):
        self.root = root
        self.loader = loader
        ...
        if dataframe is None:
            ...
            try:
                ...
                raise RuntimeError(f"アノテーションファイルが見つかりません: {annotation_file}")
        ...
        for _, row in dataframe.iterrows():
            ...
            for ext in possible_extensions:
                potential_path = os.path.join(self.root, f"{filename}{ext}")
